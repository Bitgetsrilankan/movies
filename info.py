...
USERNAME = environ.get('USERNAME', "https://t.me/oh_th") # ADMIN USERNAME
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002324418733'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/LKFilmBotSearch')
...
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002260254510'))  
BIN_CHANNEL = int(environ.get('BIN_CHANNEL','-1002376589556'))
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1002286557593'))
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002168807940'))
